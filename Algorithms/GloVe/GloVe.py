...
Original file is located at
    https://colab.research.google.com/drive/11F_oRa6L-2KlD6_kjwfpUb7zYPwKWE9x
...
import os
import numpy as np
GLOVE_DIR ='/content/drive/MyDrive/NLP/GloVe/glove.6B/'
...
"""#### Skip-Grams instead of word2vec"""
...
glove_file = datapath(GLOVE_DIR+'glove.6B.100d.txt')
...
all_text_wv.save_word2vec_format(GLOVE_DIR+'w2v_for_nn.bin')
all_text_wv.save(GLOVE_DIR+'w2v_for_nn.wordvectors')
